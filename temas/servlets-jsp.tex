...
\begin{itemize}
    ...
    \item ¿Puede haber ejercicios practicos de usar los bloques funcionales de etqietas de jstl implicatamente como core y tal?
\end{itemize}

\section*{3d-PatronesAppsWebs}

\subsection*{Dudas de conocimiento}
\begin{itemize}
    \item si lo he entendido bien lo que pasa es se hace una petición post a un controlador, este lo que hace es delegar la logica de negocio y redirigir a otra url que tiene la petición get que no modificara solo mostrara, ¿entonces al darle a comprar cambias la url pero muestra el mismo html?
    \item entiendo que este si que nos lo debemos saber entero. 
    \item Cual es la utilidadreal de crear un DTO y no usar el objeto directamente
\end{itemize}
